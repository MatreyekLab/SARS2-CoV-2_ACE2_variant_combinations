...
Grantham = pd.DataFrame(pd.read_csv("Identity.csv"))
...
textfile.to_csv("Updated_identity_sequence_file.csv", sep = ',', encoding = 'utf-8')
print("New file saved as Updated_identity_sequence_file.csv")
...
Grantham_Matrix.to_csv("Identity_sequence_matrix.csv", sep = ',', encoding = 'utf-8')
print("New file saved as Identity_sequence_matrix.csv, columns match rows of original file")
